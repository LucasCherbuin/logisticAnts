...
import { ConfirmationDeleteCommandeSecretaireComponent } from '../../../component/secretaire/confirmationDeleteCommandeSecretaire.component'; 

describe('ConfirmationDeleteCommandeSecretaireComponent', () => {
  let component: ConfirmationDeleteCommandeSecretaireComponent;
  ...
  beforeEach(() => {
    ...
    component = new ConfirmationDeleteCommandeSecretaireComponent(dialogRefMock);
  });
