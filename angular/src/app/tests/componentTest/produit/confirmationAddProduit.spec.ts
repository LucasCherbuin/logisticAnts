...
import { ConfirmationAddProduitComponent } from '../../../component/logisiticien/produit/add-update/confirmationAddProduit.component';

describe('ConfirmationAddProduitComponent', () => {
  let component: ConfirmationAddProduitComponent;

  beforeEach(() => {
    vi.useFakeTimers();
    component = new ConfirmationAddProduitComponent();
  });
